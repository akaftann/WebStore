const translit = (str: string): string =>{
    const ru = 'А-а-Б-б-В-в-Г-г-Д-д-Е-е-Ë-ё-Ж-ж-З-з-И-и-І-і-Ї-ї-Й-й-К-к-Л-л-М-м-Н-н-О-о-Р-П-п-р-С-с-Т-т-У-у-Ф-ф-Х-х-Ц-ц-Ч-ч-Ш-ш-Щ-щ-Ъ-ъ-Ы-ы-Ь-ь-Э-э-Ю-ю-Я-я'.split('-')
...
export const generateSlug = (str: string): string => {
    let url: string = str.replace(/\s+/g,'-')
    url = translit(url)
